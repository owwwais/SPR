// Re-export only. The definition lives in supabase/functions/_shared/screening.ts.
//
...
// @/lib/validations/screening as before.
export * from "../../supabase/functions/_shared/screening";
