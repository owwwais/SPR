// Re-export only. The definition lives in supabase/functions/_shared/application.ts.
//
...
// @/lib/validations/application as before.
export * from "../../supabase/functions/_shared/application";
